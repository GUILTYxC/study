...
from myapp.models import Year, Kydata,Stardict,Wordbook
...
def zhuci(request):
    ...
    if request.META.get('HTTP_X_REQUESTED_WITH') == 'XMLHttpRequest' and request.method == "POST":
        ...
        results = Kydata.objects.filter(year=selected_year, section_type=selected_type)
    ...
    return render(request, 'myapp/zhuci.html', context)
